...
- Команди
- Інспектори, прив’язані до команд
- Генерація 1 000 000 чекпоінтів
- Щоденні маршрути інспекторів
...
- Фільтрація маршрутів за командою, інспектором і датами
- Звіти по командах та інспекторах
...
```bash
git clone https://github.com/esk78/
cd route-analytics
```
